import {
  ...
  hasMemberId,
  removeMemberId,
} from '../src/07-membership-registry.js';
...
describe('07 - Membership Registry: Object Basics (9 pts)', () => {
  ...
  describe('getMemberIds', () => {
    ...
    test('returns [] for null', () => {
      expect(getMemberIds(null)).toEqual([]);
    });
  ...
  describe('getAllMembers', () => {
    ...
    test('returns [] for null', () => {
      expect(getAllMembers(null)).toEqual([]);
    });
  ...
  describe('getMembershipEntries', () => {
    test('returns [key, value] pairs', () => {
      ...
      expect(entries[0]).toEqual([
        'M001',
        { name: 'Rahul', plan: 'Gold', active: true },
      ]);
    });
    ...
    test('returns [] for null', () => {
      expect(getMembershipEntries(null)).toEqual([]);
    });
