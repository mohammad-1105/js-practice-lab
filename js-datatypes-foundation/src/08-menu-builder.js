...
export function createMenuItem(baseItem, customizations) {
  ...
  return Object.assign({}, baseItem, customizations);
}
...
export function updatePrices(menu, increase) {
  if (!isPlainObject(menu) || typeof increase !== "number") {
    return {};
  }
...
export function mergeDailySpecials(regularMenu, specialsMenu) {
  const safeRegular = isPlainObject(regularMenu) ? regularMenu : {};
  const safeSpecials = isPlainObject(specialsMenu) ? specialsMenu : {};
