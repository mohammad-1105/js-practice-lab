import { analyzeWalletTransactions } from '../src/10-digital-wallet-transactions.js';
...
describe('10 - Digital Wallet Transaction Analyzer (9 pts)', () => {
  ...
  describe('Frequent contact', () => {
    ...
    test('Single transaction - that contact is frequent', () => {
      const result = analyzeWalletTransactions([
        { id: "T1", type: "debit", amount: 500, to: "UberEats", category: "food", date: "2025-01-01" }
      ]);
  ...
  describe('Skipping invalid transactions', () => {
    ...
    test('All invalid transactions returns null', () => {
      expect(analyzeWalletTransactions([
  ...
  describe('Validation', () => {
    ...
    test('null returns null', () => {
      expect(analyzeWalletTransactions(null)).toBeNull();
    });
  });
});
